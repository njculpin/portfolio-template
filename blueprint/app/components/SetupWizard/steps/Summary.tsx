...
export default function Summary({ formData, goToStep, onSave }: any) {
  ...
  const socialDisplay = formData.social.length > 0
    ? formData.social.map((s: any) => s.platform).join(', ')
    : 'None';
  ...
  return (
    <div>
      ...
      <div className={styles.summarySection}>
        ...
        <button className={styles.summaryEdit} onClick={() => goToStep(1)}>Edit</button>
      </div>
      ...
      <div className={styles.summarySection}>
        ...
        <button className={styles.summaryEdit} onClick={() => goToStep(2)}>Edit</button>
      </div>

      <div className={styles.summarySection}>
        <span className={styles.summaryLabel}>Domain</span>
        <span className={styles.summaryValue}>{formData.domain}</span>
        <button className={styles.summaryEdit} onClick={() => goToStep(3)}>Edit</button>
      </div>
      ...
      <div className={styles.summarySection}>
        ...
        <button className={styles.summaryEdit} onClick={() => goToStep(4)}>Edit</button>
      </div>

      <div className={styles.summarySection}>
        <span className={styles.summaryLabel}>Theme</span>
        <span className={styles.summaryValue}>{formData.themePreset || 'None'}</span>
        <button className={styles.summaryEdit} onClick={() => goToStep(5)}>Edit</button>
      </div>
