...
function parseMarkdown(md: string) {
  ...
  let html = md.replace(
    /<(\/?)(script|iframe|object|embed|form|input|button|textarea|select|style|link|meta)(\s[^>]*)?\/?>/gi,
    '',
  );
...
export default function MarkdownRenderer({
  ...
  contentLoader: Post['contentLoader'];
  slug: string;
}) {
